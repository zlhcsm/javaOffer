...
- [10，堆和栈优缺点比较](#10)
- [11，不同数据类型存储](#11)
- [12，String在内存中的存放](#121)
- [12，数组在内存中的存放](#122)
- [13，static变量在内存中的存放](#13)
- [14，java中变量在内存中的分配](#14)
- [15，hashmap的快速失败策略](#15)
- [16，Object类的方法](#16)
- [17，Java类的初始化顺序](#17)
- [18，本地方法和最终方法](#18)
- [19，优先级](#19)
- [20，sleep()、wait()、yield()、join()](#20)

##### <span id = 1>1</span>，实例变量、局部变量、类变量和final变量
...
##### <span id = 2>2</span>，构造函数
>`构造函数`不能被继承，`构造方法`只能被显式或隐式的调用。
##### <span id = 3>3</span>，==、equals和hashcode()
>“\=\=”：作用是判断两个对象的地址是否相等，
...
##### <span id = 6>6</span>，String底层
>String底层是char数组
##### <span id = 7>7</span>，线程状态转换图
